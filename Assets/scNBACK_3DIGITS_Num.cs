...
public class scNBACK_3DIGITS_Num : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        scDataStore.taskType = "N-BACK-3DIGITS-NUM TASK";
...
//            txtObjReaction.text = reactionKey.ToString();
    ...
    public void NewText()
    {
        ...
        int r1 = 100, r2 = 100, eq = 100, ans = 1000;
...
//        while (ans < 0 || ans > 10)
        while (ans < 0 || ans > 999)
        {
            ...
            //It's difficult to do and to make(new button "."etc）
        ...
        {
            texObjQuestion.text = r1.ToString();
        }
        /*
        else if (eq == 0)
